...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"steemvm", "oracle", "data", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ExchangeRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"steemvm", "oracle", "data", "v1", "exchange_rate", "pair"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ExchangeRates_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"steemvm", "oracle", "data", "v1", "exchange_rates"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AggregatePrevote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"steemvm", "oracle", "data", "v1", "aggregate_prevote", "validator"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AggregateVote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"steemvm", "oracle", "data", "v1", "aggregate_vote", "validator"}, "", runtime.AssumeColonVerbOpt(false)))
)
