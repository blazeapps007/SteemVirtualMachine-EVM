...
func initRootCmd(
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		// true => `keys add` defaults to eth_secp256k1 (Ethermint-style keys).
		// Together with ChainCoinType=60 this makes a steemvmd mnemonic yield
		// the SAME account in MetaMask.
