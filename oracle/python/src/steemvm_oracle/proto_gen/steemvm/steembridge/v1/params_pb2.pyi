...
class Params(_message.Message):
    __slots__ = ("bridge_enabled", "bridge_out_enabled", "gateway_account", "bridge_confirmation_threshold", "minimum_bridge_amount", "maximum_bridge_amount", "deposit_timeout_blocks", "name_service_enabled", "name_registration_min_millisteem", "name_pending_timeout_blocks", "relayer_start_block", "bridge_fee_bps")
    ...
    bridge_fee_bps: int
    def __init__(self, bridge_enabled: bool = ..., bridge_out_enabled: bool = ..., gateway_account: _Optional[str] = ..., bridge_confirmation_threshold: _Optional[str] = ..., minimum_bridge_amount: _Optional[int] = ..., maximum_bridge_amount: _Optional[int] = ..., deposit_timeout_blocks: _Optional[int] = ..., name_service_enabled: bool = ..., name_registration_min_millisteem: _Optional[int] = ..., name_pending_timeout_blocks: _Optional[int] = ..., relayer_start_block: _Optional[int] = ..., bridge_fee_bps: _Optional[int] = ...) -> None: ...
